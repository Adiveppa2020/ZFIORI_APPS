					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "On-going Purchase Requisition Approval",
					...
					"config": {
						"inbounds": {
							"zprapzfprap-display": {
								...
								"action": "display",
								"description": "On-going Purchase Requisition Approval Process",
								"title": "On-going Purchase Requisition Approval",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zprap.zfprap",
									"url": sap.ui.require.toUrl("zprap/zfprap")
								}
							}
						}
					}
